      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
           ...
           <li class="active" id="a"> <a href="packages.php" style="color:white;font-size: 15px">Package</a></li>
                        ...
                        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td align="left" valign="top" class="gray12_txt"><table width="100%" border="0" cellpadding="1" cellspacing="1">
                              <tr>
                                <td colspan="4" align="left" valign="top"><p><strong>Fitness Club - Packages</strong></p></td>
                                </tr>
                              <tr>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-default text-center">
        <div class="panel-heading" style="background:#008000;color:white">
          <h2>General</h2>
        </div>
        <div class="panel-body">
          <p><strong>Rs.1500</strong> Monthly</p>
          <p><strong>Rs.3500</strong> Quarterly</p>
          <p><strong>Rs.6500</strong> Half-Yearly</p>
          <p><strong>Rs.10000</strong> Yearly</p>
        </div>
        <div class="panel-footer">
                   <button class="btn btn-lg" style="background:#008000;color:white">Sign Up</button>
        </div>
      </div> 
    </div> 
    <div class="col-sm-4">
      <div class="panel panel-default text-center">
        ...
        <div class="panel-body">
          <p><strong>Rs.2500</strong> Monthly</p>
          <p><strong>Rs.6500</strong> Quarterly</p>
          <p><strong>Rs.11000</strong> Half-Yearly</p>
          <p><strong>Rs.18000</strong> Yearly</p>
        </div>
        <div class="panel-footer">
          <button class="btn btn-lg" style="background:#008000;color:white">Sign Up</button>
        </div>
   ...
   <div class="col-sm-4">
      <div class="panel panel-default text-center">
        ...
        <div class="panel-body">
          <p><strong>Rs.1000</strong> Monthly</p>
          <p><strong>Rs.2500</strong> Quarterly</p>
          <p><strong>Rs.4500</strong> Half-Yearly</p>
          <p><strong>Rs.7500</strong> Yearly</p>
        </div>
        <div class="panel-footer">
          <button class="btn btn-lg" style="background:#008000;color: white">Sign Up</button>
        </div>
       ...
       <p><h5><b>Fitness Club</b> is having highly qualified team of trainers, they are widely acknowledged as being among the industry's finest and take enormous pride in assisting members wherever they are needed. All are fully accredited on the Exercise Professionals Register and are, of course, insured to deliver some of the most advanced training. They can focus clearly on your goals and pointedly be on hand to ensure you reach them.</h5><br> <h3>Note:</h3>
